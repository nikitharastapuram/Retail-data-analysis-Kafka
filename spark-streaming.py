...
if __name__ == "__main__":
    ...
    timeBasedKPIsOutput = timeBasedKPIs \
        ...
        .outputMode("append") \
        .format("json") \
        .option("path", "/tmp/TimeBasedKPI1") \
        .option("checkpointLocation", "/tmp/CPLTimeBased1") \
        .option("truncate", "False") \
        .trigger(processingTime="1 minute") \
        .start()
    ...
    timeAndCountryBasedKPIsOutput = timeAndCountryBasedKPIs \
        ...
        .outputMode("append") \
        .format("json") \
        .option("path", "/tmp/TimeAndCountryBasedKPI1") \
        .option("checkpointLocation", "/tmp/CPLTimeAndCountryBased1") \
        .option("truncate", "False") \
        .trigger(processingTime="1 minute") \
        .start()
